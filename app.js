...
const DISCLAIMERS = {
  "a-profile": {
    text: "Register data is generated based on ",
    linkText: "Arm® official architecture documents",
    linkHref: "https://developer.arm.com/Architectures/A-Profile%20Architecture#Downloads",
    suffix: ". Users are responsible for verifying the correctness of this information.",
  },
  "r-profile": {
    text: "R-Profile register data is generated by an LLM from the ",
    linkText: "Arm® Architecture Reference Manual Supplement — Armv8, for the Armv8-R AArch32 architecture profile (DDI0568A.c)",
    linkHref: "https://developer.arm.com/documentation/ddi0568/a-c/",
    suffix: ". This information may contain errors. Users are responsible for verifying correctness against the official specification.",
  },
};

function setDisclaimer(profileKey) {
  const d = DISCLAIMERS[profileKey];
  if (!d) { profileDisclaimer.textContent = ""; return; }
  profileDisclaimer.textContent = "";
  profileDisclaimer.appendChild(document.createTextNode(d.text));
  const a = document.createElement("a");
  a.href = d.linkHref;
  a.target = "_blank";
  a.rel = "noopener";
  a.textContent = d.linkText;
  profileDisclaimer.appendChild(a);
  profileDisclaimer.appendChild(document.createTextNode(d.suffix));
}
